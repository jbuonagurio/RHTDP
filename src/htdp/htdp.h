...
void iymdmj(const int iyr, const int imon, const int iday, int *mjd);

// SUBROUTINE PREDV
// Predict velocity in iopt reference frame
void predv(const double ylat, const double ylon, const double eht,
...
void newcor(const double ylat, const double ylon, const double htold,
